...
test3 = do
  ...
  putStrLn "Headers are fine"
  parseTestGood (orgBlock) $ "#+CAPTION: sdsd\n#+NAME: asas:asasre\n#+BEGIN_SRC idris\n sldkjf;sdjf;dlfj\n#+END_SRC\n\n"
  parseTestGood (orgBlock) "#+BEGIN_SRC idris\n sldkjf;sdjf;dlfj\n#+END_SRC\n\n"
  putStrLn "Source Blocks are fine"
  parseTestGood (orgBlock) "#+BEGIN_QUOTE\n dfkljfzdjf\n#+END_QUOTE\n\n"
  putStrLn "Quotes are fine"
  parseTestGood (orgBlock) "#+CAPTION: sdsd\n #+NAME: asas:asasre\n[[dfjkdjfldjkf]]\n\n"
  putStrLn "figures are fine"
  parseTestGood (many orgBlock)  $ "#+BEGIN_EQUATION\n dfdkfjlkjdfjlk\n#+END_EQUATION\n"
      ++ "#+NAME: asas\n#+BEGIN_EQUATION\n dfdkfjlkjdfjlk\n#+END_EQUATION\n\n"

test4 : Test
test4 = do
  parseTestGood (orgBlock) "+ a\n+ b\n+ c\n+ a\n+ b\n+ c\n- a\n- b\n- c\n\n"
  parseTestGood (orgBlock) "1. a\n1. b\n2. c\n3. a\n3. b\n1. c\n2. a\n2. b\n3. c\n\n"
  parseTestGood (orgBlock) "+ Term :: Description+ Term :: Description\n + Term :: Description\n + Term :: Description\n + Term :: Description\n + Term :: Description\n\n"
